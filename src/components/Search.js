  ...
  return (
    <div className="group absolute top-3 md:top-4 left-1/2 -translate-x-1/2 opacity-75 focus-within:opacity-100 transition-all ease-in-out z-10">
      ...
      {searchResults.length !== 0 && (
        <div className="w-full max-h-[50vh] bg-white relative -mt-3 p-4 pt-8 -z-10 rounded-b-xl hidden group-focus-within:flex flex-col overflow-y-auto max-w-[12rem] group-focus-within:max-w-[20rem] sm:group-focus-within:max-w-[24rem] font-medium ease-in-out transition-all hide-scrollbar shadow-xl">
